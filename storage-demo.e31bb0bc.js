...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./node_modules/picnic/picnic.min.css":"node_modules/picnic/picnic.min.css","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../storage-wrap/dist/storage-wrap.esm.js":[function(require,module,exports) {
"use strict";
...
function storage_write(key, value) {
  var storage_type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "localStorage";
...
function storage_read(key) {
  var storage_type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "localStorage";
...
var _storageWrapEsm = _interopRequireDefault(require("../storage-wrap/dist/storage-wrap.esm.js"));
...
(function () {
  ...
  function output_stored_value() {
    ...
    var stored_value = _storageWrapEsm.default.storage_read(STORAGE_KEY);
  ...
  function handle_click(e) {
    ...
    if (text_value) {
      try {
        _storageWrapEsm.default.storage_write(STORAGE_KEY, text_value);
  ...
  function handle_clear_click(e) {
    try {
      _storageWrapEsm.default.storage_clear("localStorage");
...
},{"./main.css":"main.css","../storage-wrap/dist/storage-wrap.esm.js":"../storage-wrap/dist/storage-wrap.esm.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/storage-demo.e31bb0bc.js.map