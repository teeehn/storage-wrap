...
var _storageWrap = _interopRequireDefault(require("@tomnicolosi/storage-wrap"));
...
(function () {
  ...
  function output_stored_value() {
    ...
    var stored_value = _storageWrap.default.storage_read(STORAGE_KEY);
  ...
  function handle_click(e) {
    ...
    if (text_value) {
      try {
        _storageWrap.default.storage_write(STORAGE_KEY, text_value);
  ...
  function handle_clear_click(e) {
    try {
      _storageWrap.default.storage_clear("localStorage");
...
},{"./main.css":"main.css","@tomnicolosi/storage-wrap":"../node_modules/@tomnicolosi/storage-wrap/dist/storage-wrap.umd.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
